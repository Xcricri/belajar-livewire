        ...
        <div class="space-y-8">
            ...
            <div class="space-y-3">
                ...
                <flux:text class="text-zinc-600 dark:text-zinc-400 leading-6">
                    Web ini merupakan dokumentasi pembelajaran Livewire,
                    berisi proses belajar dan implementasi dalam membangun aplikasi web modern.
                </flux:text>
            </div>

            <div class="space-y-3">
                <flux:text>
                    Hasil implementasi selama <strong class="text-zinc-700 dark:text-zinc-300">5 hari:</strong>
                </flux:text>
