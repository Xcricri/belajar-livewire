...
<div class="sticky top-0 z-50">
    ...
    <flux:header container class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700">
        ...
        <flux:brand href="#" logo="https://livewire.laravel.com/img/livewire-mascot.svg" name="Livewire"
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:dropdown class="max-lg:hidden">
                <flux:navbar.item icon:trailing="chevron-down">Pages</flux:navbar.item>
                <flux:navmenu>
                    @foreach ($pages as $page)
                        <flux:navmenu.item href="{{ url('pages/' . $page->slug) }}" wire:navigate>{{ $page->title }}
                        </flux:navmenu.item>
                    @endforeach
                </flux:navmenu>
            </flux:dropdown>
        ...
        @guest
            <flux:button href="{{ route('login') }}" variant="primary" color="zinc">Login</flux:button>
        @endguest
            ...
            <flux:dropdown position="top" align="start">
                ...
                <flux:menu>
                    <flux:menu.radio.group>
                        ...
                        <flux:menu.item href="{{ route('dashboard') }}" wire:navigate>Dashboard
                        </flux:menu.item>
                    </flux:menu.radio.group>
                    <flux:menu.separator />
