...
new class extends Component {
    ...
    {
        $enableTwoFactorAuthentication = app(
    ...
    private function loadSetupData(): void
    {
        ...
        try {
            if (!$user || !$user->two_factor_secret) {
                throw new Exception(
                    "Two-factor setup secret is not available.",
                );
            }
        ...
        <div class="flex flex-col items-center space-y-4">
            ...
            >
                ...
                >
                    ...
                    <flux:icon.qr-code
                        class="relative z-20 dark:text-accent-foreground"
                    />
                </div>
            </div>
        ...
        @else
            ...
            <div class="space-y-4">
                <div class="relative flex items-center justify-center w-full">
                    <div
                        class="absolute inset-0 w-full h-px top-1/2 bg-stone-200 dark:bg-stone-600"
                    ></div>
                    <span
                ...
                >
                    <div
                        class="flex items-stretch w-full border rounded-xl dark:border-stone-700"
                    >
