...
new class extends Component {
    ...
    {
        return $this->view()->layout("layouts::app")->title("Alpine js");
    }
};
?>
<div class="max-w-7xl mx-auto py-10">
    ...
    <!-- Toggle -->
    <div x-data="{ open: false }" class="rounded-xl p-6">
        <h2 class="text-xl font-semibold mb-4">Toggle Content</h2>

        <button
            @click="open = !open"
            class="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg transition"
        >
