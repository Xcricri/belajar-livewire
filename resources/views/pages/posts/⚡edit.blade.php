                    ...
                    <flux:field>
                        ...
                        >
                            ...
                            @if ($image)
                                ...
                                />
                                <div
                                    class="absolute top-2 left-2 bg-indigo-600 text-white text-xs px-2 py-0.5 rounded shadow"
                                >
                                    Preview Baru
                                </div>
                            @else
                                ...
                                />
                                <div
                                    class="absolute top-2 left-2 bg-zinc-700/80 text-white text-xs px-2 py-0.5 rounded shadow"
                                >
                                    Gambar Saat Ini
                                </div>
                            @endif
